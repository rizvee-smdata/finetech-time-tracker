import { VENDOR_CONSOLE_ENABLED, isVendorAdminEmail } from "@/lib/licensing/vendor";
...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/gps/audit", label: "GPS Audit", icon: ShieldAlert },
      ...
      { to: "/visits/predictions", label: "Deal Predictions", icon: Sparkles },
      { to: "/visits/account-health", label: "Account Health", icon: HeartPulse },
